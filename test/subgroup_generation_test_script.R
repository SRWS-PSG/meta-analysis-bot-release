...
dat <- read.csv('/tmp/tmpglkg9cuc.csv', na.strings = c('NA', 'na', 'N/A', 'n/a', ''))
...
summary_list$generated_plots_paths <- list(list(label = "forest_plot_overall", path = "forest_plot.png"), list(label = "forest_plot_subgroup_Region", path = "forest_plot_subgroup_Region.png"), list(label = "funnel_plot", path = "funnel_plot.png"))
...
tryCatch({
    save(res, res_for_plot, res_by_subgroup_Region, res_subgroup_test_Region, file='results.RData') 
